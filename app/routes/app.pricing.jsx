  ...
  const plans = [
    {
      ...
      price: "5",
      priceSuffix: null,
      tagline: "低门槛起步，满足基础地图展示需求",
      addonsNote: null,
      features: [
        "Up to 50 locations",
        "Manual & Bulk CSV import",
        "Widget & App Block",
    ...
    },
    {
      ...
      price: "49",
      priceSuffix: null,
      tagline: "大型连锁与经销商网络的完整解决方案",
      addonsNote: null,
      features: [
        "Unlimited locations",
        "Real-time GBP Deep Sync",
        "Mapbox / Google Maps Dual Engine",
            ...
            return (
              <div key={plan.id} className={cardClass}>
                ...
                <div className="pricing-card__body">
                  ...
                  {plan.addonsNote && <p className="pricing-card__addons">{plan.addonsNote}</p>}
                </div>
              </div>
            );
          })}
